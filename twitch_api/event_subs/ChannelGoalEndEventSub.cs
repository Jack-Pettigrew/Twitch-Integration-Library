...
/// </summary>
public partial class ChannelGoalEndEventSub : IEventSub
{
    ...
    public void ProcessEvent(JsonNode twitchResponseJson)
    {
        GoalEnd goalEnd = new GoalEnd
        {
            ...
            EndedAt = DateTime.Parse(twitchResponseJson["payload"]!["event"]!["message"]!["ended_at"]!.ToString())
        };

        EventRegistry.TriggerGoalEndReceived(goalEnd);
    }
}