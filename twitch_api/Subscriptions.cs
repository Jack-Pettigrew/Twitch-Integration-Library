...
public static class Subscriptions
{
    ...
    public const string AUTOMOD_MESSAGE_HOLD_V2 = "automod.message.hold";
    public const string AUTOMOD_MESSAGE_UPDATE = "automod.message.update";
    public const string AUTOMOD_MESSAGE_UPDATE_V2 = "automod.message.update";
    ...
    public const string CHANNEL_POINTS_AUTOMATIC_REWARD_REDEMPTION_ADD_V2 = "channel.channel_points_automatic_reward_redemption.add"; // v2, same topic, version 2
    ...
    public const string SHOUTOUT_RECEIVE = "channel.shoutout.receive";
